...
public class DoctorPayment {
	...
	public String insertDoctorPayment(String Paymentcode, String DocID, String DocName, String PaymentType, String Amount, String DateOfPayed)
	{
		String output = "";
		try
		{
		...
		{
			output = "{\"status\":\"error\", \"data\": \"Error while inserting the DoctorPayment.\"}";
	...
	public String readDoctorPayment()
	{
		String output = "";
		...
		{
			output = "Error while reading the DoctorPayment.";
			System.err.println(e.getMessage());
		}
...
//	}
	...
	public String deleteDoctorPayment(String PaymentID)
	{
		String output = "";
		...
		{
			output = "{\"status\":\"error\", \"data\": \"Error while deleting the DoctorPayment.\"}";
			System.err.println(e.getMessage());
		}
